...
namespace WaveSystem
{
    public class WaveManager : MonoBehaviour
    {
        ...
        private IEnumerable<IWaveHandler> _waveHandlers;
        private Coroutine _encounter;

        private void Awake()
        {
            _waveHandlers = FindObjectsOfType<MonoBehaviour>().OfType<IWaveHandler>();
        }
        ...
        public void StartEncounter(int index) => StartEncounter(waves[index % waves.Length]);
